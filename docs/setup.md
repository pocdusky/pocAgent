...
[repository]: https://github.com/pocdusky/pocAgent
...
1. Clone the repository
        ...
        :::shell
        git clone -b stable https://github.com/pocdusky/pocAgent.git
...
1. Download `Source code (zip)` from the [latest stable release](https://github.com/pocdusky/pocAgent/releases/latest)
...
[docker-compose file]: https://github.com/pocdusky/pocAgent/blob/stable/docker-compose.yml
