...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "{'Schaue dir meine Projekte auf github () an, als auch meine Webseiten': 'https://github.com/pocdusky/pocAgent, https://discord.gg/autogpt und https://twitter.com/SigGravitas'}",
            "{'Schaue dir meine Projekte auf github () an, als auch meine Webseiten': 'https://github.com/pocdusky/pocAgent, https://discord.gg/autogpt und https://twitter.com/SigGravitas'}",
        ),
        ("", ""),
        ("hello", "hello"),
